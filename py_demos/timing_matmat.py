...
plt.plot(sizes_et, times_et, marker='o', linestyle='-', color='b', label='Execution time (ExpTemplate)')
plt.plot(sizes_la, times_la, marker='o', linestyle='-', color='r', label='Execution time (LAPACK)')
